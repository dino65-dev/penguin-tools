...
contextBridge.exposeInMainWorld('penguin', {
  ...
  getWidgetTools: () => ipcRenderer.invoke('get-widget-tools'),
  setWidgetTools: (tools) => ipcRenderer.invoke('set-widget-tools', tools),
  onWidgetToolsChanged: (callback) => ipcRenderer.on('widget-tools-changed', (_event, tools) => callback(tools)),
